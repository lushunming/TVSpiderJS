...
class JpyySpider extends Spider {
    ...
    async parseVodShortListFromDoc($) {
        ...
        for (const vod_element of vod_elements) {
            ...
            vodShort.vod_pic = this.baseProxy + Utils.base64Encode(this.siteUrl + $(vod_element).find("img")[0].attribs["src"])
    ...
    async parseVodDetailFromDoc($) {
        ...
        vodDetail.vod_pic =this.baseProxy + Utils.base64Encode( this.siteUrl + $("img")[0].attribs["src"])
